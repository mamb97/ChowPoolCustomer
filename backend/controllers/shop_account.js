...
const signupShopUser = async (req, res) => {
  const {email, password, name, phone, unitNumber, streetAddress, city, state, zipcode, openHours, openDays} = req.body
  try {
    ...
    if(coordinates === undefined){
      ...
      const user = await Shop.signup(email, password, name, phone, unitNumber, streetAddress, city, state, zipcode,openHours, openDays, coordinates)
